 ...
 * @author: Aiden Carney
 */
public class FeatureDSMData extends AbstractDSMData implements IPropagationAnalysis {
...
//region Constructors
    /**
     * Creates a new FeatureDSMData object. Creates no row or column items and metadata are empty strings.
     * There is one grouping, which is the default: "(None)"
     */
    public FeatureDSMData() {
        super();
     ...
     */
    public FeatureDSMData(Collection<Grouping> groupings) {
        super();
    ...
    /**
     * Copy constructor for FeatureDSMData class. Performs a deep copy
     *
     * @return  the copy of the current feature DSM
     */
    @Override
    public FeatureDSMData createCopy() {
        FeatureDSMData copy = new FeatureDSMData();
